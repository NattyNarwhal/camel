// Based on MIT-licensed code from https://code.google.com/archive/p/szotar/
// Lightly enhanced for (almost) proper border rendering
...
namespace Camel
{
    ...
    public class ToolStripAeroRenderer : ToolStripSystemRenderer
    {
        ...
        public ToolStripAeroRenderer(ToolbarTheme theme, bool renderBorders = true)
        {
            Theme = theme;
